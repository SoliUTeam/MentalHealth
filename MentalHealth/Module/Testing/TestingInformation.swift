...
class TestingInformation {
    ...
    var testInfoArray: [TestQuestion] = [
        ...
        TestQuestion(id: 3, questionNumber: 15, type: "Social Media Addiction", question: "You spend a lot of time thinking about social media or planning how to use it."),
        TestQuestion(id: 3, questionNumber: 16, type: "Social Media Addiction", question: "You feel an urge to use social media more and more."),
        TestQuestion(id: 3, questionNumber: 17, type: "Social Media Addiction", question: "You use social media in order to forget about personal problems."),
        TestQuestion(id: 3, questionNumber: 18, type: "Social Media Addiction", question: "You become restless or troubled if you are prohibited from using social media."),
        TestQuestion(id: 3, questionNumber: 19, type: "Social Media Addiction", question: "You use social media so much that it has had a negative impact on your job/studies."),
        
        TestQuestion(id: 4, questionNumber: 20, type: "Loneliness", question: "I lack companionship."),
        TestQuestion(id: 4, questionNumber: 21, type: "Loneliness", question: "I feel isolated from others."),
        TestQuestion(id: 4, questionNumber: 22, type: "Loneliness", question: "I am no longer close to anyone."),
        TestQuestion(id: 4, questionNumber: 23, type: "Loneliness", question: "My interests and ideas are not shared by those around me."),
        TestQuestion(id: 4, questionNumber: 24, type: "Loneliness", question: "My social relationships are superficial."),
